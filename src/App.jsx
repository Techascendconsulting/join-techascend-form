  ...
  return (
    <div className="page">
      <header className="page__header">
        <p className="page__eyebrow">Join TechAscend</p>
        <h1 className="page__title">Apply for the Business Analyst training programme</h1>
        <p className="page__lede">
          Tell us a bit about yourself. It only takes a minute — we’ll follow up
          via WhatsApp.
        </p>
      </header>
            ...
            <div className="field">
              ...
              >
                ...
                <span className="label__parenthetical">
                  (We recommend you follow us to stay updated and access the free
                  training.)
                </span>
              </label>
              <select
      ...
      <footer className="page__footer">
        <p>Questions? Reach out through the channels we’ll share after you apply.</p>
      </footer>
    </div>
  )
}
